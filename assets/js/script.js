...
function displayWeaponImage(weaponChoice) {
    ...
    playerWeaponDiv.innerHTML = `
        <img src="/assets/images/${weaponChoice}.png" alt="${weaponChoice} image" width="60%" height="auto"></img>
    `;
}
...
function displayComputerImage(computerWeapon) {
    ...
    computerWeaponDiv.innerHTML = `
        <img src="/assets/images/${computerWeapon}.png" alt="${computerWeapon} image" width="60%" height="auto"></img>
    `;
}
